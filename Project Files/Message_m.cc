...
Msg::Msg(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->src_ip = 0;
    this->sending_time = 0;
}

Msg::Msg(const Msg& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
int Msg::getSrc_ip() const
{
    return this->src_ip;
}

void Msg::setSrc_ip(int src_ip)
{
    this->src_ip = src_ip;
}

::omnetpp::simtime_t Msg::getSending_time() const
{
    return this->sending_time;
}

void Msg::setSending_time(::omnetpp::simtime_t sending_time)
{
...
int MsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "src_ip")==0) return base+0;
...
std::string MsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Msg *pp = (Msg *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getSrc_ip());
        case 1: return simtime2string(pp->getSending_time());
        default: return "";
    }
}
...
bool MsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Msg *pp = (Msg *)object; (void)pp;
    switch (field) {
        case 0: pp->setSrc_ip(string2long(value)); return true;
        case 1: pp->setSending_time(string2simtime(value)); return true;
